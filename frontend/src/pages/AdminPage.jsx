      ...
      <section className="admin-grid-v2">
        <form className="product-form admin-card" onSubmit={handleCreateProduct}>
          ...
          <div className="admin-field-grid">
            ...
            <select value={form.category} onChange={(e) => setForm({ ...form, category: e.target.value })}><option>Kurti</option><option>Dupatta</option><option>Plazo</option><option>Bath Towel</option><option>Face Towel</option></select>
